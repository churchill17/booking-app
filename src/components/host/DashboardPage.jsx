  ...
  return (
    <div className="dashboard-page">
      <div className="page-header">
        ...
        <button className="btn-primary" onClick={() => setActivePage("property")}>
          + Add Property
        </button>
      </div>
      ...
      <div className="dashboard-grid">
        <div className="dashboard-card dashboard-card--wide">
          <div className="card-header">
            ...
            <button className="btn-ghost" onClick={() => setActivePage("bookings")}>
              View All →
            </button>
          </div>
          {bookings.length === 0 ? (
            <p className="text-muted" style={{ padding: "1rem" }}>No bookings yet.</p>
          ) : (
        ...
        <div className="dashboard-card">
          <div className="card-header">
            ...
            <button className="btn-ghost" onClick={() => setActivePage("property")}>
              View All →
            </button>
          </div>
          {topPropertyRows.length === 0 ? (
            <p className="text-muted" style={{ padding: "1rem" }}>No properties listed yet.</p>
          ) : (
                ...
                <div className="property-item" key={i}>
                  ...
                  <div className="property-info">
                    ...
                    <div className="occupancy-bar">
                      <div className="occupancy-fill" style={{ width: `${p.occupancy}%` }} />
                    </div>
                  </div>
